...
const int start_year = 2000, end_year = 2010, start_month = 1, end_month = 12, start_day = 1, end_day = 31;
...
struct out_date_range out_date = { 2000, 2010, 1, 12, 1, 31, 1, 24 };
...
const int spin_years = 8, spin_interval = 2;
bool      spin_flag = true;
