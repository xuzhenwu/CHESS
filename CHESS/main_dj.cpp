...
const int start_year = 1960, end_year = 1970, start_month = 1, end_month = 12, start_day = 1, end_day = 31;
...
struct out_date_range out_date = { 1960, 1969, 1, 12, 1, 31, 1, 24 };
...
char  outPutPath[120] = { "I://CHESS//dj//out//RE//" };
