...
char  inDefFilePrefix[120] = { "I://CHESS//cleve//60F//defs//" };
char  outPutPathPrefix[120] = { "I://CHESS//cleve//60F//out//" };
char  FlowTableNamePrefix[40] = "cleve_60_flow_table_";

const int parameter_start = 0;
const int parameter_end = 0;
const int algo_start = 2;
const int algo_end = 4;

const char algorithm[5][10] = { "F","D8","MD_inf", "MFD_md","MD8" };// 1 2 3 4
char  ParameterPrefix[10][40] = { "F//", "M1//", "M2//", "M3//" , "M4//","M5//","M6//" ,"M7//" ,"M8//" ,"M9//" };// 1-9
...
int	main(int main_argc, char **main_argv)
{
	...
	for (int parameter_inx = parameter_start; parameter_inx <= parameter_end; parameter_inx++)
		for (int algorithm_inx = algo_start; algorithm_inx <= algo_end; algorithm_inx++)
		{
			...
			char  prefix[20] = "cleve_60";


			char  inDefFile[120]{};
			char  inImgFile[120] = { "I://CHESS//cleve//60F//geo//" };
			char  inFlowFile[120] = { "I://CHESS//cleve//60F//flowtable//" };
			char  inClimPath[120] = { "I://CHESS//cleve//60F//clim//" };
