...
char  inDefFilePrefix[120] = { "I://CHESS//cleve//120F//defs//" };
char  outPutPathPrefix[120] = { "I://CHESS//cleve//120F//out//" };
...
int	main(int main_argc, char **main_argv)
{
	...
	for (int parameter_inx = parameter_start; parameter_inx <= parameter_end; parameter_inx++)
		for (int algorithm_inx = algo_start; algorithm_inx <= algo_end; algorithm_inx++)
		{
			...
			char  inDefFile[120]{};
			char  inImgFile[120] = { "I://CHESS//cleve//120F//geo//" };
			char  inFlowFile[120] = { "I://CHESS//cleve//120F//flowtable//" };
			char  inClimPath[120] = { "I://CHESS//cleve//120F//clim//" };
